        ...
        <div className="flex flex-col lg:flex-row justify-center gap-8">
          {[1, 2, 3].map((i) => (
            ...
            >
              ...
              {feature === i && (
                <button className="mx-auto bg-primary-purple text-white rounded-md py-2 px-6 font-medium">
                  Try for Free
                </button>
              )}
            </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
          {Array(4).fill(0).map((_, i) => (
            ...
            >
              ...
              <button className="mt-4 w-full border-2 border-primary-purple text-primary-purple text-md rounded-md py-2 font-semibold hover:bg-primary-purple hover:text-white transition-colors duration-300">
                Apply Design
              </button>
            </div>
          ))}
